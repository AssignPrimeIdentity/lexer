...
See that in _[6th row](#3rd-step-q36-114)_ that assigned as overall direction the tabulation of prime hexagon has the biggest numbers involved among the other rows which is 9 (nine). You may see that it simply act as the bilateral 9 sums of 43 and 89. Therefore the prime flow in the developed flowchart above should take a connection to form between them two. This is the reason why the sequence of its shapes are arranged as below:
